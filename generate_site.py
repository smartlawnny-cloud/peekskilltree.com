    ...
    <div class="container">
      <div class="footer-grid">
        ...
        <div>
          ...
          <h3 class="footer-heading" style="margin-top:20px;">Tools</h3>
          <ul class="footer-links">
    ...
    <div class="container" style="max-width:900px;">
      ...
      <div id="calc-wrap" style="background:var(--bg-light);border-radius:12px;padding:1.75rem 2rem;border:1px solid var(--border);">
        ...
        <div style="margin-bottom:1.25rem;">
          ...
          <div style="margin-top:.5rem;">
            <label style="display:flex;align-items:center;gap:.5rem;cursor:pointer;font-size:.82rem;color:var(--text-light);">
              <input type="checkbox" id="chk-discount-labor" checked onchange="calcUpdate()" style="width:16px;height:16px;">
              Apply tier discount to labor (not just equipment)
            </label>
          </div>
        </div>
        ...
        <div style="margin-top:1rem;padding:1.25rem 1.5rem;background:var(--white);border:2px solid var(--green-dark);border-radius:10px;">
          ...
          <div id="client-quote" style="display:none;background:var(--green-dark);border-radius:8px;padding:1rem 1.25rem;color:var(--white);">
            ...
            <div style="margin-top:.4rem;font-size:.82rem;opacity:.6;">
              Profit margin: <span id="profit-margin-pct" style="font-weight:700;opacity:1;color:#f9c74f;"></span>
            </div>
          </div>
        </div>
      ...
      <style>
        ...
        @media print {
          ...
          #dur-btns, #preset-btns, #travel-map,
      ...
      <script>
        ...
        var TIER_DESCS = {
          ...
          preferred: '15% off \u2014 partners who sub 3+ jobs/month.',
          coop:      '25% off \u2014 full co-op members with buy-in.'
        };
        ...
        function calcUpdate() {
          ...
          function grp(lines, id, prId, label, key, qty, isEquip) {
            ...
            var discountLabor = document.getElementById('chk-discount-labor').checked;
            var tierMult = (tierDiscount > 0 && (isEquip || discountLabor)) ? (1 - tierDiscount) : 1;
          ...
          if (profitPct > 0) {
            ...
            var marginPct = clientTotal > 0 ? Math.round((profitAmt / clientTotal) * 100) : 0;
            document.getElementById('profit-margin-pct').textContent = marginPct + '%';
          } else {
      ...
      <div style="margin-top:.75rem;padding:.9rem 1.1rem;background:var(--bg-light);border-radius:8px;font-size:.84rem;color:var(--text-light);line-height:1.7;">
        <strong style="color:var(--text);">Terms:</strong> $500 minimum call-out &bull; Mon&ndash;Sat &bull; Westchester, Putnam &amp; Southern Dutchess &bull; Payment due on booking or within 48 hrs &bull; Our jobs come first; same/next-day when schedule permits.
      </div>
